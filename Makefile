...
fuzz-smat:
	...
	go-fuzz-build -func FuzzSmat github.com/chirlchen/roaring
	go-fuzz -bin=./roaring-fuzz.zip -workdir=workdir/ -timeout=200


fuzz-stream:
	go-fuzz-build -func FuzzSerializationStream github.com/chirlchen/roaring
	go-fuzz -bin=./roaring-fuzz.zip -workdir=workdir/ -timeout=200


fuzz-buffer:
	go-fuzz-build -func FuzzSerializationBuffer github.com/chirlchen/roaring
	go-fuzz -bin=./roaring-fuzz.zip -workdir=workdir/ -timeout=200
